...
const SubscriptionPremium = ({ navigation }) => {
    return (
            ...
            <ScrollView style={{ backgroundColor: '#2C2939', flex: 1, }}>
                <View style={styles.logoView}>
                    ...
                    <View style={{ marginHorizontal: 10 }}>
                        ...
                        <Text style={styles.itOutTxtPre}>PREMIUM</Text>
                    </View>
                </View>
                <View style={{ paddingHorizontal: 25 }}>
                    <Text style={styles.loginTxt}>SUBSCRIBE</Text>
                    ...
                    <View style={styles.btnview}>
                        <TouchableOpacity style={{marginRight:10}}>
                            <Text style={styles.subTxt}>SAVE</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => { navigation.navigate('LoginPremium') }}>
...
const styles = StyleSheet.create({
    ...
    itOutTxtPre: { textAlign: 'center', color: '#1592E6', fontFamily: Typography.FONT_FAMILY_BOLD, fontSize: 18, marginLeft: 12, marginTop: -17, },
    ...
    btnview:{flexDirection:'row', justifyContent:'center', alignItems:'center'},
